...
$start = ($page - 1) * $per_page;
 $sql = "SELECT uid,first_name,phone_number,`status`,FROM_UNIXTIME(create_time/1000, '%d/%M/%Y' ) create_time
    FROM t_user where role=2 order by uid desc limit $start, $per_page";
