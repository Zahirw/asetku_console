            ...
            <div class="">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
				  <a href="lending_management_add.php"><button type="button" class="btn btn-round btn-danger">Add New Product</button></a><br/><br/>
                   ...
                   <div class="form-group">
                    ...
                    <?php
                            ...
                            if(isset($_GET['page']))
                                $page = $_GET['page'];
                    ?>
                      <select id="limit" class="form-control" onChange="myFunction()">
                ...
                <script>
                    ...
                    $('#limit').on('change', function() {
                            /* alert( this.value ); */
                            window.location = 'lending_management.php?page='+ page +'&count=' + this.value;
                        });
                  </script>
                      
				  <?php include 'lending_management_data.php'; ?>
                  </div>
                </div>
              </div>
