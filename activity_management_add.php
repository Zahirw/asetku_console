            ...
            <div class="">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <form action="activity_management_add_data.php" method="post"  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input type="date" name="begin_time" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="first-name">Activity End Time<span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input type="date" name="end_time" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input type="text" name="url" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					...
					<!----------------------- form upload -------------------------
					 ...
					 <!----------------------- form upload end ------------------------->
                      ...
                      <?php include 'activity_management_add_data.php'; ?>
                    </form>
                  </div>
                </div>
              </div>
