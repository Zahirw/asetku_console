                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                            ...
                            <form  action="edit_personal.php?id=<?php echo $uid; ?>" method="post" class="form-horizontal form-label-left input_mask">
									  <div class="form-group">
										<label class="control-label col-md-1 col-sm-3 col-xs-12">UID</label>
										<div class="col-md-1 col-sm-6 col-xs-12">
										  <input type="text" class="form-control" readonly="readonly" value="<?php echo $uid;?>">
										</div>
										 <label  class="control-label col-md-2 col-sm-3 col-xs-12">Name <span class="required">*</span></label>
										<div class="col-md-3 col-sm-6 col-xs-12">
										  <input type="text" name="name" required="required" class="form-control" value="<?php echo ucfirst($name);?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-1 col-sm-3 col-xs-12">Phone <span class="required">*</span></label>
										<div class="col-md-2 col-sm-6 col-xs-12">
										  <input type="text" required="required" name="phone" class="form-control" value="<?php echo ucfirst($phone);?>">
										</div>
										 <label class="control-label col-md-1 col-sm-3 col-xs-12">Gender</label>
										<div class="col-md-2 col-sm-6 col-xs-12">
										  <input type="text" name="gender" class="form-control" value="<?php echo ucfirst($gender);?>">
										</div>
									  </div>
									   <div class="form-group">
										...
										<div class="col-md-2 col-sm-6 col-xs-12">
										  <input type="text" name="rlgi" class="form-control" value="<?php echo ucfirst($rlgi);?>">
										</div>
									  </div>
									  <div class="form-group">
									   <label class="control-label col-md-1 col-sm-3 col-xs-12">Place Of Birth</label>
										<div class="col-md-2 col-sm-3 col-xs-12">
										  <input type="text" name="plcBr" class="form-control" value="<?php echo ucfirst($plcBr);?>">
										</div>
										<label class="control-label col-md-1 col-sm-3 col-xs-12">Date Of Birth <span class="required">*</span></label>
										<div class="col-md-3 col-sm-3 col-xs-12">
										  <input type="date" required="required" name="dtBr" class="form-control" value="<?php echo $dtBr;?>">
										</div>
									  </div>
									  <div class="form-group">
									  ...
									  <div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <textarea id="message" required="required" class="form-control" name="addrs" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.." data-parsley-validation-threshold="10"><?php echo $addrs;?>
										  </textarea>
										</div>
									  </div>
									  <div class="form-group">
										...
										<div class="col-md-2 col-sm-6 col-xs-12">
										  <input type="text" name="city" class="form-control" value="<?php echo ucfirst($city);?>">
										</div>
										<label class="control-label col-md-1 col-sm-3 col-xs-12">Province</label>
										<div class="col-md-2 col-sm-6 col-xs-12">
										  <input type="text" name="provi" class="form-control" value="<?php echo ucfirst($provi);?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-1 col-sm-3 col-xs-12">Country</label>
										<div class="col-md-2 col-sm-6 col-xs-12">
										  <input type="text" readonly="readonly" name="cntry" class="form-control" value="<?php echo ucfirst($cntry);?>">
										</div>
										<label class="control-label col-md-1 col-sm-3 col-xs-12">Occupation</label>
										<div class="col-md-2 col-sm-6 col-xs-12">
										  <input type="text" name="occup" class="form-control" value="<?php echo ucfirst($occup);?>">
										</div>
									  </div>
                          ...
                          <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                            ...
                            <form action="edit_personal.php?id=<?php echo $uid; ?>" method="post" class="form-horizontal form-label-left input_mask">
								  <div class="form-group">
									...
									<div class="col-md-2 col-sm-6 col-xs-12">
									  <input type="text" name="edu" class="form-control" value="<?php echo ucfirst($edu);?>">
									</div>
									<label class="control-label col-md-2 col-sm-3 col-xs-12">Field Of Job</label>
									<div class="col-md-3 col-sm-6 col-xs-12">
									  <input type="text" name="fldJb" class="form-control" value="<?php echo ucfirst($fldJb);?>">
									</div>
								  </div>
								  <div class="form-group">
									<label class="control-label col-md-1 col-sm-3 col-xs-12">Type Of User</label>
									<div class="col-md-2 col-sm-6 col-xs-12">
									  <input type="text" name="tpUsr" class="form-control" value="<?php echo ucfirst($tpUsr);?>">
									</div>
									<label class="control-label col-md-2 col-sm-3 col-xs-12">Name ofLegal Entity</label>
									<div class="col-md-3 col-sm-6 col-xs-12">
									  <input type="text" name="nmLeg" class="form-control" value="<?php echo ucfirst($nmLeg);?>">
									</div>
								  </div>
								  <div class="form-group">
									<label class="control-label col-md-1 col-sm-3 col-xs-12">Type Of Legal Entity</label>
									<div class="col-md-2 col-sm-6 col-xs-12">
									  <input type="text" name="tpLeg" class="form-control" value="<?php echo $tpLeg;?>">
									</div>
									<label class="control-label col-md-2 col-sm-3 col-xs-12">Legal Entity / Corporation ID</label>
									<div class="col-md-3 col-sm-6 col-xs-12">
									  <input type="text" name="legal" class="form-control" value="<?php echo $legal;?>">
									</div>
								  </div>
								  <div class="form-group">
										<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          ...
                          <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                            ...
                            <form action="edit_personal.php?id=<?php echo $uid; ?>" method="post" class="form-horizontal form-label-left input_mask">
								  ...
								  <div class="form-group">
									...
									<div class="col-md-3 col-sm-6 col-xs-12">
									  <input type="text" name="accName" class="form-control" value="<?php echo $accName;?>">
									</div>
								  </div>
								  <div class="form-group">
										<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
						  ...
						  <div role="tabpanel" class="tab-pane fade" id="tab_content4" aria-labelledby="profile-tab">
                            ...
                            <form action="edit_personal.php?id=<?php echo $uid; ?>" method="post" class="form-horizontal form-label-left input_mask">
								  <div class="form-group">
									...
									<div class="col-md-3 col-sm-6 col-xs-12">
									  <input type="text" name="pLogn" class="form-control" value="<?php echo $pLogn;?>">
									</div>
								  </div>
								  <div class="form-group">
									<label class="control-label col-md-1 col-sm-3 col-xs-12">Password Withdraw</label>
									<div class="col-md-3 col-sm-6 col-xs-12">
									  <input type="text" name="pWith" class="form-control" value="<?php echo $pWith;?>">
									</div>
								  </div>
								  <div class="form-group">
									<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
