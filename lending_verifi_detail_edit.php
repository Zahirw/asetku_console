										  ...
										  <label class="control-label col-md-1 col-sm-3 col-xs-12">UID</label>
											...
											<label class="control-label col-md-2 col-sm-3 col-xs-12">Name <span class="required">*</span></label>
												<div class="col-md-3 col-sm-9 col-xs-12">
													<div class="">
														<input type="text" name="phone" required="required" class="form-control" value="<?php echo ucfirst($name);?>">
														</div>
												</div>
											<label class="control-label col-md-1 col-sm-3 col-xs-12">Country</label>
												<div class="col-md-2 col-sm-9 col-xs-12">
													<input type="text" name="phone" class="form-control" value="<?php echo ucfirst($name);?>">
												</div>
									  </div>
									  <div class="form-group">
